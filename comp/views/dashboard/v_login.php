      ...
      <div class="login-box-body">
        ...
        <form id="form_login">
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Login" id="Login" name="LoginAdmin">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Mot de passe" id="Mdp" name="MdpAdmin">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button type="button" class="btn btn-primary btn-block btn-flat" onclick="Connecter()">Connecter</button>
            </div><!-- /.col -->
          </div>
        </form>
