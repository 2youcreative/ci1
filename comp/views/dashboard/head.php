...
<html>
    <head>
        ...
        <title>Admin Space | Dashboard</title>
        ...
        <link href="<?php echo site_url('assets/datatables/css/dataTables.bootstrap.css" rel="stylesheet'); ?>">
        ...
        <link href="<?php echo base_url(); ?>assets/mycss/jasny-bootstrap.min.css" rel="stylesheet" media="screen">
    </head>