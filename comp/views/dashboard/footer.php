...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="http://www.2youcreative.com">2youcreative</a>.</strong> 
    ...
    <aside class="control-sidebar control-sidebar-dark">
      ...
      <!-- src="plugins/jvectormap/jquery-jvectormap-world-mill-en.js" -->
	    <!-- jQuery Knob Chart -->
	    <script></script>
      <!-- src="plugins/knob/jquery.knob.js" -->
	    <!-- daterangepicker -->
	    <script ></script>
      ...
      <!-- src="plugins/fastclick/fastclick.min.js" -->
	    <!-- AdminLTE App -->
