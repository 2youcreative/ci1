...
function edit_compte()
{
  ...
  var url;
  url = "http://9rawkhdem.com/profilme/edit_compte/";
...
function save_desc()
{
  if($("textarea.en_bref_txt").val()!=" "){
    ...
    var url;
    url = "http://9rawkhdem.com/profilme/save_desc/";
...
function edit_activity()
{
    ...
    $.ajax({
      url : "http://9rawkhdem.com/profilme/edit_activity/",
      type: "POST",
      data: dataser,
      dataType: "JSON",
      success: function(data)
...
{
  var url = "http://9rawkhdem.com/uploads/"+fileName;
