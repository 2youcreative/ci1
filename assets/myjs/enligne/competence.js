...
function edit_comp(id)
{
  ...
  save_method = 'update';
  $.ajax({
      url : "http://9rawkhdem.com/competence/comp_edit/"+id,
      type: "POST",
      dataType: "JSON",
...
{      
  ...
  if(save_method == 'add')
  {
    url = "http://9rawkhdem.com/competence/comp_add/"+id_user;
  } 
  else if(save_method == 'update')
  {
    url = "http://9rawkhdem.com/competence/comp_update";
  }
...
function delete_comp(id)
{
  ...
  {
    $.ajax({
        url : "http://9rawkhdem.com/competence/comp_delete/"+id,
        type: "POST",
        dataType: "JSON",
        success: function(data)
        {
