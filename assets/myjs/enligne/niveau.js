      ...
      $(document).ready(function(){
        ...
        table = $("#table_niveau").DataTable({ 
          ...
          "order": [],
          "ajax": {
            "url": "http://9rawkhdem.com/sysdba/niveau/ajax_list",
            "type": "POST"
          },
          "columnDefs": [
            { 
      ...
      function edit_niveau(id)
      {
        ...
        $.ajax({
            url : "http://9rawkhdem.com/sysdba/niveau/ajax_edit/" + id,
            type: "POST",
            dataType: "JSON",
      ...
      function save()
      {
        ...
        if(save_method == 'add')
        {
          url = "http://9rawkhdem.com/sysdba/niveau/ajax_add/";
        } 
        else 
        {
          url = "http://9rawkhdem.com/sysdba/niveau/ajax_update";
        }
      ...
      function delete_niveau(id)
      {
        if(confirm('Are you sure delete this data?'))
        {
          ...
          $.ajax({
              url : "http://9rawkhdem.com/sysdba/niveau/ajax_delete/"+id,
              type: "POST",
              dataType: "JSON",
              success: function(data)
              {
