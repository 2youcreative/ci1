...
******/
        table = $("#table_activity").DataTable({ 
          ...
          "order": [],
          "ajax": {
            "url": "http://9rawkhdem.com/sysdba/activity/ajax_list",
            "type": "POST"
          },
          "columnDefs": [
            { 
      ...
      function edit_activity(id)
      {
        ...
        $.ajax({
            url : "http://9rawkhdem.com/sysdba/activity/ajax_edit/" + id,
            type: "GET",
            dataType: "JSON",
      ...
      function save()
      {
          ...
          if(save_method == 'add')
          {
            url = "http://9rawkhdem.com/sysdba/activity/ajax_add/";
          } 
          else 
          {
            url = "http://9rawkhdem.com/sysdba/activity/ajax_update";
          }
      ...
      function delete_activity(id)
      {
        ...
        {
          $.ajax({
              url : "http://9rawkhdem.com/sysdba/activity/ajax_delete/"+id,
              type: "POST",
              dataType: "JSON",
              success: function(data)
              {
